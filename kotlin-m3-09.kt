...
fun main() {
    ...
    println()
    val matrixB = arrayOf(
        intArrayOf(14, 28, 71, 142, 165),
        intArrayOf(213, 274, 376, 391, 425),
        intArrayOf(473, 521, 582, 617, 674)
    )
    val y = matrixB.size/2
    val x = matrixB[y].size/2

    println("Медианой массива является элемент '" + matrixB[y][x] + "'")
    //-------------------------------------------------------------
    println()
